    ...
    async function handleMenu(anchor) {
        ...
        if (index > -1) {
            if (typeof current !== 'undefined') {
                ...
                console.error(`Error en ${option}. No hay un objeto asignado a current.`)
            }
        } else {
            switch (option) {
                case '#pasajeros':
            await Helpers.loadPage(
             "./resources/html/pasajeros.html", '#layout > main > section'
          )
            const { default: Pasajeros } = await import(`./pasajeros.js`)
                ...
                case '#aviones':
                    await Helpers.loadPage(
                        "./resources/html/aviones.html", '#layout > main > section'
                     )
                ...
                case '#trayectos':
                    await Helpers.loadPage(
                        "./resources/html/trayectos.html", '#layout > main > section'
                     )
                ...
                case '#vuelos':
                    await Helpers.loadPage(
                        "./resources/html/vuelos.html", '#layout > main > section'
                     )
                ...
                case '#reservas':
                    await Helpers.loadPage(
                        "./resources/html/reservas.html", '#layout > main > section'
                     )
                ...
                case '#contacto':
                    console.warn(`Sin implementar ${option}`)
                    break;
                default:
